...
#+BEGIN_SRC emacs-lisp
  (use-package org
    ...
    (set-face-attribute 'org-hide nil :background "#000000")

    ;; (if (and nil (eq theme 'dark))
    ;;     (progn
...
#+begin_src emacs-lisp
  ...
  (use-package treesit-auto
    ...
    (treesit-auto-langs '(yaml javascript typescript tsx))
    :config
...
#+begin_src emacs-lisp
  (defun hbournis/load-dark-theme ()
    ...
    (set-face-attribute 'mode-line-active nil
                        :background "#7a33b3"
                        :box '(:line-width (1 . 3) :color "#7a33b3"))
