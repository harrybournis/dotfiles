...
#+BEGIN_SRC emacs-lisp
  ...
  (if (member default-font-var (font-family-list))
    ...
    (cond (IS-WINDOWS
           (set-face-attribute 'default nil :font (concat fallback-font-var "-" alternate-font-size-var)))
          (t (set-face-attribute 'default nil :font (concat fallback-font-var "-" default-font-size-var)))))
