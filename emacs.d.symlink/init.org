...
#+begin_src emacs-lisp
  (use-package aggressive-indent
    ...
    (add-to-list 'aggressive-indent-excluded-modes '(elisp-mode js2-mode web-mode typescript-mode)))
#+end_src
*** csv-mode
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  ...
  (defun hbournis/generic-open-doc ()
    ...
    (interactive)
    (hbournis/call-interactively-func-truthy-output 'gethash major-mode hbournis/open-doc-map))

  (defun hbournis/generic-show-repl ()
    "Show the repl depending on major mode."
    (interactive)
    (hbournis/call-interactively-func-truthy-output 'gethash major-mode hbournis/show-repl-map))
#+end_src
** TDD mode
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  ...
  (defun hbournis/kill-all-buffers ()
