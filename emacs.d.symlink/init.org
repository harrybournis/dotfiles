...
#+BEGIN_SRC emacs-lisp
  ...
  ;; uniquify buffer names. (not working. uniquify void.)
  ;; (setq uniquify-buffer-name-style nil nil (uniquify))
...
#+BEGIN_SRC emacs-lisp
  (use-package general
    ...
    (general-define-key :prefix basic-nav-leader
                        ...
                        "s"       'ag-project
                        "v"       'org-cliplink
                        "SPC"     (lambda() (interactive)(find-file "~/Documents/org/stuff.org"))
...
#+BEGIN_SRC emacs-lisp
  (use-package org
    ...
    (setq org-src-fontify-natively t
          ...
          org-agenda-files (quote ("~/documents/org/album.org" "~/documents/org/stuff.org"))
...
*** WAITING desktop
Save session.
I need to read up more on it before i enable it.
...
#+BEGIN_SRC emacs-lisp
  (find-file "~/Documents/org/stuff.org")
#+END_SRC
* Start emacs server
