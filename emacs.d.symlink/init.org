...
#+BEGIN_SRC emacs-lisp
  (use-package general
    ...
    (general-create-definer basic-nav-leader :prefix "SPC" :keymaps '(normal visual motion) :non-normal-prefix "C-SPC")
    ...
    (general-create-definer extra-tools-leader :prefix "'" :keymaps '(normal visual))
