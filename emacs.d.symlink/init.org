...
#+BEGIN_SRC emacs-lisp
  (setq hbournis/projects-dir           "~/Documents/projects"
        ...
        hbournis/org-dir                (if (boundp 'hbournis/org-dir) hbournis/org-dir "~/org")
        hbournis/org-main-file          (concat hbournis/org-dir "/stuff.org")
        hbournis/org-book-file          (concat hbournis/org-dir "/books.org")
        hbournis/org-mobile-file        (concat hbournis/org-dir "/mobile_notes.org")
        hbournis/org-album-file         (concat hbournis/org-dir "/album.org")
        hbournis/org-inbox-file         (concat hbournis/org-dir "/Inbox.org")
        hbournis/org-journal-file       (concat hbournis/org-dir "/journal.org.gpg")
        hbournis/recurring-file         (concat hbournis/org-dir "/recurring.org")
        hbournis/bookmarks-file         (concat hbournis/org-dir "/bookmarks.org")
        hbournis/private-bookmarks-file (concat hbournis/org-dir "/private-bookmarks.org.gpg")
...
#+BEGIN_SRC emacs-lisp
  (use-package general
    ...
    (basic-nav-leader
      ...
      "c"         'hbournis/project-relative-path-to-clipboard
    ...
    (extra-tools-leader
      ...
      "l"   'hbournis/position-to-kill-ring
    ...
    (extra-tools-alternate-leader
      ...
      "rf"  'eglot-format-buffer
      "rb"  'ruby-toggle-block
      "rr"  'project-rails-goto-routes
      "rt"  'project-rails-find-current-spec
      ))
#+END_SRC
*** magit
#+BEGIN_SRC emacs-lisp
...
#+begin_src emacs-lisp
  (use-package savehist
    ...
    (savehist-ignored-variables '(evil-jumps-history))
...
#+begin_src emacs-lisp
  (use-package flymake
    :straight '(:type built-in)
    :config
    (setq flymake-fring-indicator-position 'right-fringe))
...
#+begin_src emacs-lisp
  (use-package project
    ...
    (:keymaps 'project-prefix-map
              ...
              "t" 'hbournis/open-terminal)
    :config
    (setq project-vc-extra-root-markers '(".project.el")
          project-vc-ignores '("./.stversions" "./vendor")
          project-switch-commands '((project-find-file "Find file") (consult-ripgrep "Ripgrep")
                                    (magit-project-status "Magit") (hbournis/open-terminal "Terminal"))))
#+end_src
*** UNIX_ONLY flyspell
...
#+begin_src emacs-lisp
  (use-package consult
    ...
    (setq consult-preview-key nil
          consult-buffer-sources '(consult-source-recent-file consult-source-buffer consult-source-bookmark))
...
#+begin_src emacs-lisp
  ...
  (use-package treesit-auto
    ...
    (treesit-auto-langs '(yaml javascript typescript tsx html typst ruby))
    :config
...
#+BEGIN_SRC emacs-lisp
  (use-package git-gutter
    ...
    :defer 3
    :diminish
    :custom (git-gutter:disabled-modes '(asm-mode image-mode pdf-view-mode))
    :config
...
#+begin_src emacs-lisp
  (use-package highlight-indentation
    :straight t
    :hook (yaml-pro-ts-mode . highlight-indentation-current-column-mode)
    :config
    (if (eq theme 'dark)
        (set-face-attribute 'highlight-indentation-current-column-face nil :background "#292e42")))
#+end_src
*** which-key
...
#+begin_src emacs-lisp
  ...
  (use-package dirvish
    ...
    (if IS-MAC (setq insert-directory-program "gls" dired-use-ls-dired t))
...
#+begin_src emacs-lisp
  (use-package copilot
    :straight t
    :general (:keymaps 'copilot-completion-map "<backtab>" 'copilot-accept-completion)
    :config (setq copilot-version "1.282.0"))
#+end_src
*** fireplace
#+begin_src emacs-lisp
...
*** emacs-pets
#+begin_src emacs-lisp
  ;; (add-to-list 'load-path "lisp/emacs-pets")

  (use-package emacs-pets
    :straight (:host github :repo "harrybournis/emacs-pets" :files ("*.el" "*.txt"))
    ;; :straight (:local-repo "~/.emacs.d/lisp/emacs-pets" :files ("*.el" "*.txt"))
    :hook (custom-mode-line-mode . emacs-pets-mode))
#+end_src
...
#+BEGIN_SRC emacs-lisp
  (use-package markdown-mode
    ...
    :general (:states 'motion :keymaps 'markdown-mode-map
                      "gh" 'markdown-previous-visible-heading
                      "gn" 'markdown-next-visible-heading))
#+END_SRC
**** YAML
#+BEGIN_SRC emacs-lisp
  (use-package yaml-pro
    ...
    :hook (yaml-pro-ts-mode . display-line-numbers-mode)
...
#+begin_src emacs-lisp
  (use-package slim-mode
    ...
    :general (:states 'motion :keymaps 'slim-mode-map "gh" 'slim-up-list))
#+end_src
**** NOT_WORK vue-mode
#+begin_src emacs-lisp
  (use-package vue-mode
    :straight t
    :mode "\\.vue\\'"
    :hook ((vue-mode . display-line-numbers-mode)
           (vue-mode . prettier-js-mode)
           (vue-mode . mise-mode)
           (vue-mode . flymake-mode)
           (vue-mode . eglot-ensure)
           (vue-mode . yas-minor-mode)
           (vue-mode . smartparens-strict-mode)
           (vue-mode . evil-matchit-mode)
           (vue-mode . corfu-mode))
    :config
...
#+BEGIN_SRC emacs-lisp
  (use-package typescript-mode
    ...
    ((typescript-ts-mode tsx-ts-mode) . flymake-mode)
...
#+BEGIN_SRC emacs-lisp
  (use-package ruby-mode
    ...
    :hook ((ruby-mode . ruby-ts-mode)
           ...
           (ruby-ts-mode . mise-mode)
           (ruby-ts-mode . flymake-mode)
           (ruby-ts-mode . eglot-ensure)
           (ruby-ts-mode . yas-minor-mode)
           (ruby-ts-mode . smartparens-strict-mode)
           (ruby-ts-mode . aggressive-indent-mode)
           (ruby-ts-mode . evil-matchit-mode)
           (ruby-ts-mode . corfu-mode))
    :general (:states 'motion :keymaps 'ruby-ts-mode-map
                      "gh" 'ruby-beginning-of-block
                      "gp" 'ruby-beginning-of-block
                      "gn" 'ruby-end-of-block)
    :config
...
#+begin_src emacs-lisp
  (use-package project-rails
    :straight t
    :hook ((ruby-ts-mode inf-ruby-mode project-rails-server-mode) . project-rails-mode))
#+end_src
**** UNIX_ONLY rspec-mode
...
#+END_SRC
**** UNIX_ONLY minitest-mode
#+BEGIN_SRC emacs-lisp
  (use-package minitest
    :straight t
    :hook ruby-ts-mode
    :general (:keymaps 'minitest-compilation-mode-map "r" 'minitest-rerun)
    :config
    (inf-ruby-switch-setup)
...
#+begin_src emacs-lisp
  (use-package custom-mode-line
    :straight '(built-in :local-repo "~/.emacs.d/lisp/custom-mode-line")
    :demand t
    :config
...
#+begin_src emacs-lisp
  (use-package tokyo-night
    :straight '(:type git :host github :repo "bbatsov/tokyo-night-emacs")
    :demand t
    :init
    (add-to-list 'custom-theme-load-path (concat user-emacs-directory "/straight/build/tokyo-night-emacs/")))
...
#+end_src
** Copy file name relative to project
#+begin_src emacs-lisp
  (defun hbournis/project-relative-path-to-clipboard (&optional buffer)
    "Copy current buffer's file path relative to the project root (project.el) to the clipboard.
  If not in a project, copy the file's absolute path. If BUFFER is non-nil, use that buffer.
  If the buffer isn't visiting a file, do nothing and return nil."
    (interactive)
    (let* ((buf (or buffer (current-buffer)))
      ...
      (if (not file)
        ...
        (let* ((proj (project-current))
          ...
          (hbournis/copy-to-clipboard path)
          path))))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (setq hbournis/find-definition-map
        #s(hash-table size 4 test eq data (
                                           ruby-ts-mode    xref-find-definitions
                                           typescript-mode xref-find-definitions
  ...
  (defun hbournis/get-generic-lookup-mode ()
    (let ((is-ruby (eq major-mode 'ruby-ts-mode))
  ...
  (defun hbournis/tdd-split ()
    ...
    (let ((current-file (buffer-file-name))
      ...
      (if (hbournis/ruby-test-file-p current-file)
          (project-rails-find-current-spec))
      (split-window-horizontally)
      (project-rails-find-current-spec)
