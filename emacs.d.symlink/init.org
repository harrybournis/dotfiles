...
#+BEGIN_SRC emacs-lisp
  (if (and (eq system-type 'windows-nt) (file-exists-p (concat user-emacs-directory ".api-keys")))
      (progn
...
#+BEGIN_SRC emacs-lisp
  ...
  (if (member default-font-var (font-family-list))
      (cond (IS-MAC
            ...
            (IS-WINDOWS
             (set-face-attribute 'default nil :font (concat default-font-var "-" windows-font-size-var))))
