...
*** open terminal below
#+BEGIN_SRC emacs-lisp
  (defun hbournis/open-terminal-below ()
    (interactive)
    (progn
      (split-window-below)
      (other-window 1)
...
#+BEGIN_SRC emacs-lisp
  (use-package flycheck
    ...
    (setq-default flycheck-disabled-checkers
                  (append flycheck-disabled-checkers '(javascript-jshint json-jsonlint scss-lint)))
...
#+BEGIN_SRC emacs-lisp
  (use-package workgroups2
    ...
    (setq wg-session-file "~/Dropbox/emacs/.emacs_workgroups")
