...
#+BEGIN_SRC emacs-lisp
  (setq org-main-file-location "~/Dropbox/org/mobile/stuff.org"
        org-mobile-file-location "~/Dropbox/org/mobile/mobile_notes.org"
        org-gcal-file-location   "~/Dropbox/org/gcal.org"
        org-agenda-files-var  (quote ("~/Dropbox/org/mobile/stuff.org"
...
#+BEGIN_SRC emacs-lisp
  (use-package general
    ...
    (general-define-key :prefix basic-nav-leader
                        ...
                        "s"       'ag-project
                        "="       (lambda() (interactive) (toggle-light-dark-theme))
    ...
    (general-define-key :prefix extra-tools-leader
                        ...
                        "wd"      'sp-unwrap-sexp
                        "]"       (lambda() (interactive) (org-align-all-tags-right))
...
#+BEGIN_SRC emacs-lisp
  (use-package org
    ...
    (setq org-src-fontify-natively t               ;; Use language's syntax highlighting in code blocks
          ...
          org-todo-keywords '((sequence "TODO" "IN-PROGRESS" "WAITING" "SOMEDAY" "DONE"))
...
#+BEGIN_SRC emacs-lisp
  (defun org-align-all-tags-right ()
    ;; Align org tags to the right of the screen
    (setq org-tags-column (+ 4 (- (window-total-width))))
    (org-align-all-tags))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  link in the form of [[url][*]], leave point at * and enter insert mode."
    ...
    (let ((link (substring-no-properties (x-get-selection 'CLIPBOARD)))
          ...
          (url  "\\(http[s]?://\\|www\\.\\)"))
      (save-match-data
        (if (and (not (string-match url-org link)) (string-match url link))
            (progn
              (insert (concat "[[" link "][]]"))
              (backward-char 2)
              (evil-insert 1))
