...
#+BEGIN_SRC emacs-lisp
  (setq org-main-file-location-var   "~/Google Drive/org/stuff.org"
        org-mobile-file-location-var "~/Dropbox/org/mobile/mobile_notes.org"
        org-book-file-location-var   "~/Google Drive/org/books.org"
        org-gcal-file-location-var   "~/Google Drive/org/gcal.org"
        org-gcal-file-apergia-var    "~/Google Drive/org/gcal-apergia.org"
        org-agenda-file-location-var "~/Google Drive/org/journal.org.gpg"
        org-inbox-file-location-var  "~/Dropbox/org/mobile/Inbox.org"
        org-work-file-location-var   "~/Documents/work.org"
        org-agenda-files-var         '(
                                     "~/Google Drive/org/stuff.org"
                                     "~/Dropbox/org/mobile/mobile_notes.org"
                                     "~/Google Drive/org/gcal.org"
                                     "~/Dropbox/org/mobile/album.org"
                                     "~/Dropbox/org/mobile/Inbox.org"
                                     "~/Documents/work.org"
                                     "~/org/work.org"
                                     )
        ...
        mac-font-size-var            "15"
        windows-font-size-var        "11"
...
#+BEGIN_SRC emacs-lisp
  (use-package general
    ...
    (basic-nav-leader "" nil
                      ...
                      "i"         (lambda () (interactive) (find-file org-inbox-file-location-var))
                      "z"         (lambda () (interactive) (find-file org-work-file-location-var)))
        ...
        (use-package org-gcal
          ...
          (setq org-gcal-client-id     api-keys-org-gcal-client-id
                ...
                org-gcal-file-alist    `((,api-keys-org-gcal-email . ,org-gcal-file-location-var)
                                         (,api-keys-org-gcal-apergia-id . ,org-gcal-file-apergia-var)))
...
#+BEGIN_SRC emacs-lisp
  (setq org-capture-templates `(
                                ...
                                ("b" "Book" entry (file+headline org-book-file-location-var
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-agenda-files (seq-filter 'file-exists-p org-agenda-files-var)
  ...
  (setq org-agenda-custom-commands '(("c" "Startup Agenda"
                                      (
                                       (tags "-work+.*"
                                                ((org-agenda-files `(,org-inbox-file-location-var))
                                       ...
                                       (tags "PRIORITY=\"A\""
                                             ((org-agenda-files (remove-if (apply-partially #'equal org-inbox-file-location-var)
                                                                            org-agenda-files))
...
#+BEGIN_SRC emacs-lisp
  ...
  (if (member default-font-var (font-family-list))
      (cond (IS-MAC
             (set-face-attribute 'default nil :font (concat default-font-var "-" mac-font-size-var)))
            (IS-LINUX
             (set-face-attribute 'default nil :font (concat default-font-var "-" alternate-font-size-var)))
            (IS-WINDOWS
             (set-face-attribute 'default nil :font (concat default-font-var "-" windows-font-size-var) :weight 'semi-bold)))

    (cond (IS-WINDOWS
           (set-face-attribute 'default nil :font (concat fallback-font-var "-" windows-font-size-var)))
          (t (set-face-attribute 'default nil :font (concat fallback-font-var "-" mac-font-size-var)))))
  ...
  (when (member unicode-font-var (font-family-list))
    (cond (IS-MAC
           (set-fontset-font t 'unicode (concat unicode-font-var "-" mac-font-size-var) nil 'prepend))
          (IS-LINUX
           (set-fontset-font t 'unicode (concat unicode-font-var "-" mac-font-size-var) nil 'prepend))
          (IS-WINDOWS
           (set-fontset-font t 'unicode (concat unicode-font-var "-" windows-font-size-var) nil 'prepend)))
    )
#+END_SRC
** Themes
*** Color Scheme
